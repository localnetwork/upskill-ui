  ...
  return (
    <section className="py-24 bg-[#F9FAFB] overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <h2 className="text-4xl md:text-5xl font-bold text-slate-900 mb-12 text-center font-secondary">
          What our students say
        </h2>
        <div className="flex gap-6 overflow-x-auto pb-8 scrollbar-hide snap-x md:grid md:grid-cols-3 md:overflow-visible">
          <div className="min-w-[85vw] md:min-w-0 snap-center bg-white border border-slate-100 rounded-2xl p-8 shadow-sm hover:shadow-md transition-shadow">
            <div className="flex items-center gap-4 mb-6">
              {/* <img alt="Student" className="w-14 h-14 rounded-full bg-slate-100 border border-slate-50" src="https://lh3.googleusercontent.com/aida-public/AB6AXuCrSZCsXpUBY-4bFS2oKphjZGngF2gf7u31VXZsU6vZotR0hwREM6d0N5l-h3zOB79RxYR1mgnYhSRh2Wg5OWBBt1D6hhX0n8CmDenogPfR9bOvJdlxoKqla2WbjmeTXdM7S1EwbofTMy4UZvyPnSWJrJ2DJKAsPmVbR4FKCFvpJesQTE8H599K4nUvi4VJxZIXMy_czywsIYeyxR8cTIxoefBT7AhoPrSNbFga1k7HZ4aY_JREEBK1kerfJjmzy2TnfGUcT9cNmPSQ"> */}
              <div>
          ...
          <div className="min-w-[85vw] md:min-w-0 snap-center bg-white border border-slate-100 rounded-2xl p-8 shadow-sm hover:shadow-md transition-shadow">
            <div className="flex items-center gap-4 mb-6">
              {/* <img alt="Student" className="w-14 h-14 rounded-full bg-slate-100 border border-slate-50" src="https://lh3.googleusercontent.com/aida-public/AB6AXuBI6EcJcUlySY6DdyrUMrx3U11nELnkvv8-19F960cxCRtEar7dvpOwPFtCr13C0mvD88_UnNAtN9GJ8KksRU_R5NLzRjM3HL-HMM7qa7pDKiFjSIxNruJhEi4gpSYkMzkpprAB2VBj7P3lJofL-c3T_kna9glvPBslu45VkoWek0gJDADj4oWXOWbvfCBAS4vEBJb8-sCwVutk8cf4zQ95VbrNk8GRaOHpcErLfBSdxBSryKVzyx4aSBi7y120qvFvDTCYvby2RiZq"> */}
              <div>
          ...
          <div className="min-w-[85vw] md:min-w-0 snap-center bg-white border border-slate-100 rounded-2xl p-8 shadow-sm hover:shadow-md transition-shadow">
            <div className="flex items-center gap-4 mb-6">
              {/* <img alt="Student" className="w-14 h-14 rounded-full bg-slate-100 border border-slate-50" src="https://lh3.googleusercontent.com/aida-public/AB6AXuBSdoxk22dJ6BRuleKe53epd2VGNW-JLrWjjTtzBYDqmeSvcqZRnhG_QRSHrvZvDBTS6hOnLaE2sLryJB9S4jY85eDGPsKn9TbCINY2OIqKAeU231QWAf0hZnSNWcsXTdiWmBHksY4hCuDjk4G4kWz8OxNIcsapZdhJ8C28ryPR95VS5XuZKdbQCDVo4hUCN-trDcVDQfaACE-Y0zGCE10WeQkvAhzkxqKbWVpjz9Q8ekt0ow6-HwTb5TE4K60jcEU6oeMkmE5dqHpc"> */}
              <div>
                <h4 className="font-bold text-slate-900">Elena Rodriguez</h4>
                <p className="text-xs text-slate-500">UX Designer at Netflix</p>
              </div>
            </div>
            <div className="flex text-orange-400 mb-4">
              <span className="material-symbols-outlined text-sm fill-1">
