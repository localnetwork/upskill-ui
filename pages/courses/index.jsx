        ...
        <div className="w-full mb-12">
          <div className="relative flex items-center bg-white shadow-xl shadow-slate-200/50 rounded-2xl border border-gray-100 p-2">
            ...
            <input
              ...
              type="text"
            />
            <button className="absolute right-2 bg-primary text-white font-bold px-8 py-3.5 rounded-xl hover:brightness-110 active:scale-95 transition-all">
              Search
            </button>
          </div>
        ...
        <div className="flex items-center justify-between mb-8 gap-4 flex-wrap">
          <div className="flex items-center gap-4">
            ...
            >
              ...
              />
              <span className="ml-2 font-bold text-sm hidden sm:inline">
                Filter
              </span>
            </label>
          </div>
